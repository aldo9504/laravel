...
<div class="relative min-h-screen flex   ">
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
      <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
        style="background-image: url(https://posgrados.tesi.org.mx/siad/imagenes/f4s.jpg);">
        <div class="absolute bg-gradient-to-b from-indigo-600 to-blue-500 opacity-75 inset-0 z-0"></div>
        <div class="w-full  max-w-md z-10">
          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Registrate a residencias profesionales</div>
          <div class="sm:text-sm xl:text-md text-gray-200 font-normal"> Si vas en los ultimos semestres registrate a residencias profesionales podras enviar la documentacion solicitada por el Tecnologico de estudios superiores Ixtapaluca ¡No pierdas el tiempo y no te quedes fuera! 
            </div>
        </div>
        <!---remove custom style-->
       <ul class="circles">
      ...
      <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
        <div class="max-w-md w-full space-y-8">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-500">Favor de ingresar con tu cuenta!</p>
          </div>
          ...
          <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="relative">
              ...
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Curp</label>
              <input
                class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500"
                type="" placeholder="ingresa tu curp" value="">
            </div>
            <div class="mt-8 content-center">
              ...
              <input
                ...
                type="" placeholder="ingresa tu contraseña" value="">
            </div>
            ...
            <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
              ...
              <a href=""
                class="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Registrate</a>
            </p>
          </form>
        </div>
      </div>
